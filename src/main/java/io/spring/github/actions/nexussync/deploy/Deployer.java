...
public class Deployer {
	...
	private void deploymentValidated(Deployment deployment) {
	...
	private void deploymentPublished(Deployment deployment) {
	...
	private void deploymentFailed(Deployment deployment) {
